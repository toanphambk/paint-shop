...
return {Condition1:Condition1, Condition2:Condition2, Condition3:Condition3, Condition4:Condition4, Condition5:Condition5, Condition6:Condition6, Condition7:Condition7, Condition8:Condition8}
 ...
 'PLACEHOLDER_VISIBILITY8' : true,
 'PLACEHOLDER_VISIBILITYELSE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'AlarmFrameH10689'});
new emosWS.ESColorSwapMulti({'conditionFunction' : function() {
 var myFlt = false;
var myWrn = false;
...
myWrn = (GetAlarmGroupPropertyAsInteger('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110', 'PrioMin2') > 0);
;
 Condition1 = myFlt;
 Condition2 = myWrn;
 Condition3 = false;
...
return {Condition1:Condition1, Condition2:Condition2, Condition3:Condition3, Condition4:Condition4, Condition5:Condition5, Condition6:Condition6, Condition7:Condition7, Condition8:Condition8}
 ...
 'PLACEHOLDER_VISIBILITY8' : true,
 'PLACEHOLDER_VISIBILITYELSE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'AlarmFrameH10692'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
...
return {Condition1:Condition1, Condition2:Condition2, Condition3:Condition3, Condition4:Condition4, Condition5:Condition5, Condition6:Condition6, Condition7:Condition7, Condition8:Condition8}
 ...
 'STDPLACEHOLDER_SHAPENAME' : 'Arrow_L693'});
new emosWS.ESColorBlink({"conditionFunction" : function(){
var condition = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1062_Fwd')
return condition;
},
"PLACEHOLDER_SWAP_FILLCOLOR" : true,
"PLACEHOLDER_SWAP_STROKECOLOR" : false,
...
"PLACEHOLDER_VISIBILITYOFF" : false,
"PLACEHOLDER_VISIBILITYFALSE" : false,
"STDPLACEHOLDER_SHAPENAME" : 'Arrow_L694'});
new emosWS.ESColorSwapMulti({'conditionFunction' : function() {
;
 Condition1 = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1257_Manu');
 Condition2 = false;
 Condition3 = false;
 Condition4 = false;
 Condition5 = false;
...
return {Condition1:Condition1, Condition2:Condition2, Condition3:Condition3, Condition4:Condition4, Condition5:Condition5, Condition6:Condition6, Condition7:Condition7, Condition8:Condition8}
 ...
 'STDPLACEHOLDER_SHAPENAME' : 'Arrow_R694'});
new emosWS.ESColorBlink({"conditionFunction" : function(){
var condition = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1063_Rev')
return condition;
},
"PLACEHOLDER_SWAP_FILLCOLOR" : true,
"PLACEHOLDER_SWAP_STROKECOLOR" : false,
...
"PLACEHOLDER_VISIBILITYOFF" : false,
"PLACEHOLDER_VISIBILITYFALSE" : false,
"STDPLACEHOLDER_SHAPENAME" : 'Arrow_R695'});
new emosWS.ESColorSwapMulti({'conditionFunction' : function() {
;
 Condition1 = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1257_Manu');
 Condition2 = false;
...
;
 ...
 'PLACEHOLDER_USESTROKE' : false,
 'PLACEHOLDER_USEHIDE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'BackgroundH10677'});
new emosWS.ESDiagnosisWindow({'conditionFunction' : function() {
;
 DiagnosisLibID = 3;
 PLC = 'P1Y2C5';
...
;
 ...
 'PLACEHOLDER_USESTROKE' : false,
 'PLACEHOLDER_USEHIDE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'BackgroundH10680'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
...
Condition2=(Select2&&(CDK2==DEV2)) || !Select2
; 
 Tag = 'P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.CB.C1121_FwdSelVisu';
 Value = '-1';
 Enabled = g_ManualMode.value && Condition2;
return {Tag:Tag, Value:Value, Enabled:Enabled};
 },
 ...
 'PLACEHOLDER_USESHAND' : true,
 'PLACEHOLDER_USESHIDE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'Button1H10696'});
new emosWS.ESClickWrite({'conditionFunction' : function() {
; 
...
Condition1=(Select1&&(CDK1==DEV1)) || !Select1
; 
 Tag = 'P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.CB.C1122_RevSelVisu';
 Value = '-1';
 Enabled = g_ManualMode.value && Condition1;
return {Tag:Tag, Value:Value, Enabled:Enabled};
 },
 ...
 'PLACEHOLDER_USESHAND' : true,
 'PLACEHOLDER_USESHIDE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'Button2H10697'});
new emosWS.ESClickWrite({'conditionFunction' : function() {
; 
 Tag = 'P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.AA.I8011_AreaNr';
 Value = GetTagValueAsString('P1Y2C5.P1Y2C5_2C5CD02_CDK.AA.I8011_AreaNr');;
...
new emosWS.ESColorSwap({'conditionFunction' : function() {
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'EL117'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
...
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var condition = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1252_Enbl')
 return condition;
 },
 'PLACEHOLDER_SWAP_FILLCOLOR' : false,
 'PLACEHOLDER_SWAP_STROKECOLOR' : false,
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : true,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'EnableH10688'});
...
new emosWS.ESColorSwap({'conditionFunction' : function() {
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'FX117'});
new emosWS.ESDiagnosisWindow({'conditionFunction' : function() {
;
 DiagnosisLibID = 3;
 PLC = 'P1Y2C5';
...
;
 ...
 'PLACEHOLDER_USESTROKE' : false,
 'PLACEHOLDER_USEHIDE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'LabelH10690'});
new emosWS.ESDiagnosisWindow({'conditionFunction' : function() {
;
 DiagnosisLibID = 3;
 PLC = 'P1Y2C5';
...
;
 ...
 'PLACEHOLDER_USESTROKE' : false,
 'PLACEHOLDER_USEHIDE' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'LabelH10693'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var gLifeSB, gLifeQ;
...
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var condition = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1389_EnDataChangeVisu')
 return condition;
 },
 'PLACEHOLDER_SWAP_FILLCOLOR' : false,
 'PLACEHOLDER_SWAP_STROKECOLOR' : false,
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'LockH10691'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
...
DEV2=GetTagValueAsInteger('P1Y2C5.P1Y2C5_2C5CD07_LO155_LO155.AA.I8011_AreaNr');
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'ManuSelectedLH10680'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var Select2;
var CDK2,DEV2;
Select2=GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD06_LO115_LO115.SB.S1107_FwdSelVisu');
...
DEV2=GetTagValueAsInteger('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.AA.I8011_AreaNr');
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'ManuSelectedLH10683'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var Select1;
var CDK1,DEV1;
Select1=GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD06_TC170_TC170.SB.S1107_FwdSelVisu');
...
DEV1=GetTagValueAsInteger('P1Y2C5.P1Y2C5_2C5CD07_LO155_LO155.AA.I8011_AreaNr');
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'ManuSelectedRH10678'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var Select1;
var CDK1,DEV1;
Select1=GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD06_LO115_LO115.SB.S1108_RevSelVisu');
...
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var condition = GetTagValueAsBoolean('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.SB.S1071_Occ')
 return condition;
 },
 'PLACEHOLDER_SWAP_FILLCOLOR' : false,
 'PLACEHOLDER_SWAP_STROKECOLOR' : false,
...
new emosWS.ESDynamicText({'conditionFunction' : function() {
 var iSkidNr = 0;
iSkidNr = GetTagValueAsDouble('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.IL.SD.I1030_RBDataSkidNo');
; 
 Text = GetAsString(iSkidNr);
 Enabled = true;
return {'Text' : Text, 'Enabled' : Enabled};
 ...
 'PLACEHOLDER_STROKECOLORQUALITYGOOD' : '#000000',
 'PLACEHOLDER_STROKECOLORQUALITYBAD' : '#FF8000',
 'STDPLACEHOLDER_SHAPENAME' : 'SkidNr1H10684'});
new emosWS.ESColorSwap({'conditionFunction' : function() {
 var iSkidNr = 0;
iSkidNr = GetTagValueAsDouble('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110.IL.SD.I1030_RBDataSkidNo');
 var condition = iSkidNr > 0
...
myWrn = (GetAlarmGroupPropertyAsInteger('P1Y2C5.P1Y2C5_2C5CD02_LO110_LO110', 'PrioMin2') > 0);
 ...
 'PLACEHOLDER_VISIBILITYFALSE' : false,
 'PLACEHOLDER_SWAP_HIDEIFQUALITYBAD' : false,
 'STDPLACEHOLDER_SHAPENAME' : 'WarningIconH10689'});
