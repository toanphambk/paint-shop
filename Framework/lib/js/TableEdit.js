function TableEdit(configuration) {
	this.useHTMLElement = true;
	this.tableName = configuration["tableName"];
	this.tableNameID = configuration["tableNameID"];
	this.headerText = configuration.headerText || [];
	this.headerTextID = configuration.headerTextID || [];
	this.fontSize = configuration["font-size"];
	this.PLCTagArray = configuration["PLCTagArray"];
	this.inputArray = configuration["inputArray"];
	this.unit = configuration["unit"];
	this.precision = configuration["precision"] == 1 ? true : false;
	this.editableFunction = configuration["editable"] ? configuration["editable"] : (function(){return true;});
	this.initialize = this.initialize.bind(this);
	this.init();
	this.securityGID = configuration["SecurityGID"];
	this.securityGIdx = configuration["SecurityGIdx"];
	this.IOObject = "";
	
	emosWS.ForeignObject.call(this, configuration);
	
	emosWS.addEventListener("authentication", this.authentication.bind(this));
}
TableEdit.prototype = Object.create(emosWS.ForeignObject.prototype);
TableEdit.prototype.constructor = TableEdit;
TableEdit = TableEdit;

TableEdit.prototype.authentication = function (e) {		
	this.userRight = CheckUserRight(this.securityGID, this.securityGIdx);
	this.refreshUI();
};
...
TableEdit.prototype.initialize = function () {
	try {
		this.editable = this.editableFunction();
		if (this.PLCTagArray instanceof Function){
			var value = this.PLCTagArray();
			if (value != undefined && window.onChange && this.table){
				this.plc = window.onChange();
				this.table.firstChild.innerHTML = "";
...
TableEdit.prototype.renderMore = function () {
	
	this.divElement.parentElement.style.overflow = "hidden";
	this.create();
};

TableEdit.prototype.refreshUI = function () {
	
	if (!this.element)
		return;
	
	if (this.editable && this.userRight){
		$(this.element).find(".EditBox").removeAttr('readonly');	
		$(this.element).find(".EditBox").css('color', "#105395");			
	} else { 
		$(this.element).find(".EditBox").attr('readonly', true);	
		$(this.element).find(".EditBox").css('color', "#000000");
	}
	
	if ($(this.element).hasClass('scroll'))
		return;
	
	if ($(this.element).height() < ($(this.element).find("#tableHeader").height() + $(this.element).find("#tableBody").height())){
		this.scrollUpDownButton('scrollUp', false);
		this.scrollUpDownButton('scrollDown', true);
	}
};

TableEdit.prototype.scrollUpDownButton = function (updown, active) {    
	
	var parent = this.element;
	
	this.element.className = "scroll";
	var scroll = document.createElement('div');
	scroll.style.position = "fixed";
	scroll.style.bottom = "0px";
	scroll.style.height = "34px";
	scroll.style.width = "75px";
	scroll.style.backgroundRepeat = "no-repeat";
	scroll.style.backgroundSize = "75px 34px";
	parent.appendChild(scroll);
	scroll.addEventListener("click", this.onClickScroll);
	
	if (updown === "scrollUp"){
		scroll.style.marginLeft = "-65px";
		scroll.style.left = "calc(50% - 5px)";
		if (active){
			scroll.className = "scrollUp active";
			scroll.style.backgroundImage = "url('data:image/png;base64,')";
		} else {
			scroll.style.backgroundImage = "url('data:image/png;base64,')";
			scroll.className = "scrollUp";
		}
	} else {
		scroll.style.left = "calc(50% + 5px)";
		if (active){
			scroll.className = "scrollDown active";
			scroll.style.backgroundImage = "url('data:image/png;base64,')";
		} else {
			scroll.style.backgroundImage = "url('data:image/png;base64,')";
			scroll.className = "scrollDown";
		}
	}
}

TableEdit.prototype.onClickScroll = function (event) {  

	if (!$(event.target).hasClass('active'))
		return; 

	var scroll = $(event.target).closest('.scroll');
	var contentScroll = scroll.find('#tableBody');
	
	if ($(event.target).hasClass('scrollDown') && ((contentScroll.height() + scroll.find('#tableHeader').height() + 34) > scroll.height())){
		var tr = contentScroll.find('tr:visible');
		
		for (var i = 0; i < 5; i++){
			$(tr[i]).css('display', 'none');
		}
		
		var scrollUp = scroll.find('.scrollUp');
		scrollUp[0].className = "scrollUp active";
		scrollUp[0].style.backgroundImage = "url('data:image/png;base64,')";		
		
		if ((contentScroll.height() + scroll.find('#tableHeader').height() + 34) < scroll.height()){
			event.target.className = "scrollDown";
			event.target.style.backgroundImage = "url('data:image/png;base64,')";
		}
		
	} else if ($(event.target).hasClass('scrollUp')){
		var tr = contentScroll.find('tr:hidden');
		for (var i = tr.length; i >= (tr.length - 5) ; i--){
			$(tr[i]).css('display', 'table-row');
		}
		
		var scrollDown = scroll.find('.scrollDown');
		scrollDown[0].className = "scrollDown active";
		scrollDown[0].style.backgroundImage = "url('data:image/png;base64,')";
	
		if (contentScroll.find('tr:hidden').length < 1){
			event.target.className = "scrollUp";
			event.target.style.backgroundImage = "url('data:image/png;base64,')";
		}
	}
}

TableEdit.prototype.create = function () {
	
	var panel = document.createElement('div');
	/*var isIE = (false || !!document.documentMode) ? "24px" : "16px";
	panel.style.fontSize = this.fontSize == "" ? isIE : this.fontSize;*/
	panel.style.fontSize = this.fontSize == "" ? "12px" : this.fontSize;
	...
	tableHeader.style.border = "1px solid #BFBFBF";
    tableHeader.style.borderBottom = "0px";
	panel.appendChild(tableHeader);
	var tbodyHeader = document.createElement('tbody');
	tableHeader.appendChild(tbodyHeader);
	
	if (this.tableName != ""){
		var trOver = document.createElement('tr');
		tbodyHeader.appendChild(trOver);
		var thOver = document.createElement('th');
		thOver.colSpan = this.headerText.length;
		thOver.innerText = this.tableName;
		thOver.style.borderBottom = "1px solid #f2f2f2";
		thOver.style.background = "white";
		trOver.appendChild(thOver);
		
		if (this.tableNameID != ""){
			this.getHeaderText(this.tableNameID, thOver);
		}
	}
	
	var trHeader = document.createElement('tr');
	trHeader.style.background = "#bfbfbf";
	/*var isIE = (false || !!document.documentMode) ? "24px" : "16px";
	trHeader.style.fontSize = this.fontSize == "" ? isIE : this.fontSize;*/
	tbodyHeader.appendChild(trHeader);
	
	var columnName = this.headerText;
	var textIDArray = this.headerTextID;

	for (var i = 0; i < columnName.length; i++){
		var thHeader = document.createElement('th');
		thHeader.style.textAlign = "center";
		thHeader.style.padding = "0px";
		thHeader.style.paddingLeft = "5px";
		thHeader.style.width = 100/columnName.length + "%";
		thHeader.innerText = columnName[i];
		trHeader.appendChild(thHeader);
		this.getHeaderText(textIDArray[i], thHeader);
	}
	
	var preTableScroll = document.createElement('div');
	preTableScroll.style.height = "calc(100% - " + $(tableHeader).height() + "px)";
	panel.appendChild(preTableScroll);
	
	var preTable = document.createElement('div');
	preTableScroll.appendChild(preTable);
	
	var table = document.createElement('table');
	table.id = "tableBody";
	table.style.borderCollapse = "collapse";
	table.style.width = "100%";
	preTable.appendChild(table);
...
TableEdit.prototype.getHeaderText = function (textID, header) {
...
TableEdit.prototype.drawTable = function(table){
	var selfT = this;

	for (var i = 0; i < this.plc.length; i++){
		var tr = document.createElement('tr');
		table.firstChild.appendChild(tr);
		
		for (var j = 0; j < this.plc[i].length; j++){
			var th = document.createElement('th');
			th.style.textAlign = "center";
			th.style.padding = "0px";
			th.style.background = i % 2 != 0 ? '#D9DFE4' : "white";
			th.style.width = 100/this.plc[i].length + "%";
			tr.appendChild(th);
			
			var tag = this.plc[i][j];
			th.name = tag;
			
			var elementInput = document.createElement("input");
			elementInput.setAttribute('type', 'text');
			elementInput.className = "EditBox";
			/*var isIE = (false || !!document.documentMode) ? "24px" : "16px";
			elementInput.style.height = this.fontSize == "" ? isIE : this.fontSize;*/
			elementInput.style.fontSize = this.fontSize == "" ? "12px" : this.fontSize;
			elementInput.style.fontFamily = "Roboto, sans-serif";
			elementInput.style.backgroundColor = "transparent";
			elementInput.style.width = "calc(100% - 8px)";
			elementInput.style.paddingLeft = "5px";
			elementInput.style.borderWidth = "1px";
			elementInput.style.textAlign = "center";
			th.appendChild(elementInput);
			
			var callback;
			if (this.inputArray[i][j] == 0){
				elementInput.addEventListener("click", selfT.showNumpad);
				
				this.IOObject = emosWS.advise(tag, callback = function (msg) {
					if (msg.quality == 0)
						return;
				
					var cell = selfT.getTableCell(table, msg);
					var value = msg.value.value;
				
					if (msg.value.properties != null){
						if (selfT.precision && msg.value.value != null && msg.value.properties.disp_prec != null)
							value = (msg.value.value).toFixed(msg.value.properties.disp_prec);
						if (selfT.unit == 1 && msg.value.properties.imp_baseunit != null)
							value += " " + msg.value.properties.imp_baseunit;
					} 
				
					cell.children[0].value = value;
				
				}, "", emosWS.tagType.IOObject, "", 1, "", 1, "", 1, "", 2, 0);
				elementInput.IOObject = this.IOObject;
				
			} else {
				
				if (this.inputArray[i][j] == 1 || this.inputArray[i][j] > 2)
					VKI_attach(elementInput);
				
				emosWS.advise(tag, callback = function (msg) {
					if (msg.quality == 0)
						return;
				...
				elementInput.tag = tag;
			}

			this.element.addEventListener("keyup", function(event) {
				if (event.keyCode === 13){
					var tag = event.target.IOObject ? event.target.IOObject.tag : event.target.tag;
					if (event.target.IOObject){
						saveValue();
					} else if (self.VKI_target){
						emosWS.poke(self.VKI_target.tag, self.VKI_target.value);
						self.VKI_target.data = self.VKI_target.value;
						self.VKI_close();	
					} else{
						emosWS.poke(tag, event.target.value);
					}
				}
			})
		}
...
TableEdit.prototype.showNumpad = function (event) {
	
	if (self.VKI_target)
		self.VKI_close();
	var widget = document.getElementById('numpad');
	if (widget) {
		$(widget).data("ems-numpad").destroy();
		$(widget).remove();
	}
	...
	numpad.id = "numpad";
	numpad.data = event.target;
	numpad.value = event.target.value;
	document.getElementsByTagName('body')[0].appendChild(numpad);
	var cancel = document.createElement('div');
	cancel.className = "cancelbutton emosbutton";
	numpad.appendChild(cancel);
	cancel.addEventListener("click", hideNumpad);
	var save = document.createElement('div');
	save.className = "savemebutton emosbutton";
	numpad.appendChild(save);
	save.addEventListener("click", saveValue);
	$(numpad).numpad({
		'myid': event.target
	});
	numpad.style.left = event.clientX + "px";
	numpad.style.top = (event.clientY + 30) + "px";
	if (numpad.offsetWidth + event.clientX > document.body.children[0].offsetWidth) {
		numpad.style.left = (event.clientX - numpad.offsetWidth) + "px";
	}
	if (numpad.offsetHeight + event.clientY > document.body.children[0].offsetHeight) {
		numpad.style.top = (event.clientY - numpad.offsetHeight - 30) + "px";
	}
...
function hideNumpad() {
	...
	if (numpad) {
		numpad.data.value = numpad.value;
		$(numpad).data("ems-numpad").destroy();
		$(numpad).remove();
	}
}
function saveValue () {
	var numpad = document.getElementById('numpad');
	numpad.data.IOObject.setValue(numpad.data.value);
	if (numpad) {
		$(numpad).data("ems-numpad").destroy();
		$(numpad).remove();
	}
		...
		this._on(this.document, {
			'mouseup.nummer': function (e) {
				if ($(elementId).val() === "") {
					...
					$(elementId).val($(elementId).val() + $(e.target).text());
				}
			},
...
TableEdit.prototype.addEditXFunctionality = function () {
	var e = this.element,
...
TableEdit.prototype.getTableCell = function (table, msg, nextCell) {
	...
	for (var i = 0; i < end; i++){
		...
		for (var j = 0; j < table.rows[i].cells.length; j++){
			var th = table.rows[i].cells[j];
			
			if (th.name === msg.tag){
				return nextCell ? table.rows[i].cells[j + 1] : th;
			}
		}
	}
}
...
var 
	mywindow = window.opener || window.parent,
    CAS_LOADED = "CAS_LOADED",    
    TRUST_DOMAIN = "*";
    	
if (mywindow) {
   	mywindow.postMessage(JSON.stringify({ type: CAS_LOADED }), TRUST_DOMAIN);
}
...
(function() {
   ...
   *
   */
  this.VKI_show = function(elem, event) {
    if (!this.VKI_target) {
	  ...
	  if ((event.clientY + 340) > window.innerHeight)
		self.VKI_keyboard.style.top = (event.clientY - 370) + "px";
	  else if ((event.clientY + 30) > 0)
		self.VKI_keyboard.style.top = (event.clientY + 30) + "px";
	
      if ((event.clientX + 460) > window.innerWidth)
		self.VKI_keyboard.style.left = (event.clientX - 920) + "px";
	  else if ((event.clientX - 460) > 0)
		self.VKI_keyboard.style.left = (event.clientX - 460) + "px";
	  
      //if (self.VKI_isMoz || self.VKI_isWebKit) this.VKI_position(true);
      this.VKI_target.blur();
      this.VKI_target.focus();
	  this.VKI_target.data = VKI_target.value;
    } else this.VKI_close();
  };
  ...
  this.VKI_close = VKI_close = function() {
    if (this.VKI_target) {
      try {
		this.VKI_target.value = this.VKI_target.data;
