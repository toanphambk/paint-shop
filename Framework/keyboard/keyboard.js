                  ...
                  case "Enter":
                    ...
                    VKI_addListener(td, 'click', function() {
                      if (self.VKI_target.nodeName !== "TEXTAREA") {
                        ...
                        $(self.VKI_target).trigger('change');
                        if(self.VKI_target.getAttribute('name') === 'search') {
                            startJsonSearch($(self.VKI_target));
                        }
                        self.VKI_close();
  ...
  this.VKI_position = function(force) {
    if (self.VKI_target) {
      ...
      if (place || force === true) {
        ...
        if(self.VKI_target.getAttribute('name') === 'search') {
            var rect = self.VKI_target.getBoundingClientRect();
            self.VKI_keyboard.style.top = rect.top + 35 + 'px';
        } else {
